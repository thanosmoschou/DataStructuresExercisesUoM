...
void FindIntersection(ListPointer *AList,ListPointer *BList, ListPointer *CList, ListPointer PredPtr1, ListPointer PredPtr2, ListPointer PredPtr3);


//Main function
int main()
{
    ListPointer AList, BList, CList, PredPtr1, PredPtr2, PredPtr3;
	//int choice, choice1;
    ...
    if(sumNum2 > 0)
        Filling(&BList, sumNum2, PredPtr2 = NULL);
    ...
    if(!EmptyList(AList) && !EmptyList(BList))
    {
        FindIntersection(&AList, &BList, &CList, PredPtr1, PredPtr2, PredPtr3 = NULL);
        printf("\nTeliki lista\n");
        LinkedTraverse(CList);
        printf("\n");
    }
    else
    {
...
void FindIntersection(ListPointer *AList,ListPointer *BList, ListPointer *CList, ListPointer PredPtr1, ListPointer PredPtr2, ListPointer PredPtr3)
{
    ...
    while(curr != NULL)
    {
        ...
        if(found)
        {
            ...
            while(curr3 != NULL)
            {
                if(curr3->Data == curr2->Data) //It was already existing in the 3rd list the data of the 2nd List
                {
                    found2 = TRUE;
                    break;
                }
            ...
            if(!found2)
                LinkedInsert(CList, curr2->Data, PredPtr2);
        }
